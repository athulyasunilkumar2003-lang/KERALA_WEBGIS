...
map.getView().fit([8047122.562088, 913478.086338, 8904426.760456, 1449108.239556], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">KERALA DISTRICTS</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (82 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = ' AS A PART OF MSC PROGRAMME , THIS WEBSITE IS CREATED USING OPEN SOURCE SOFTWARE .';
            }
